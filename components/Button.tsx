...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-brand-red-600 hover:bg-brand-red-700 text-white shadow-lg hover:shadow-brand-red-900/40",
    secondary: "bg-gray-800 hover:bg-gray-900 text-white shadow-md hover:shadow-lg",
    outline: "border-2 border-brand-red-600 text-brand-red-600 hover:bg-brand-red-50"
  };
